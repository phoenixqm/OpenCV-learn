...
switch name1
  ...
  case 'occ'
    setIds=[0:5 11:15]; subdir='Occ'; skip=30; minHt=25;
    vidIds={0:14 0:5 0:11 0:12 0:11 0:12 0 0 0 0 0 };
%     vidIds={0:14 0:5 0:11 0:12 0:11 0:12 0:18 0:11 0:10 0:11 0:11 0 0 0 0 0 };
