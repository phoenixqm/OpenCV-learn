function [rs] = dbEval_new_test(FramesEval, choice, gndSel, Cnum)
...
for i = 1
  ...
  switch(choice)
      ...
      case 61, preName='MR_new_IC-CNN';%INRIA_newparts111, words are smaller
...
if(types(1))
  ...
  for g=1:nGt
    for d=1:nDt, stra1{d}=sprintf('%.2f%% %s',rs1(g,d)/100,stra{d}); end
...
[pth,setIds,vidIds,skip] = dbInfo('usatest');
for i=1:nExp
